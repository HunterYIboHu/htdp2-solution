...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname ex144-checked-average) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
; check weather the list is empty before
...
(define (checked-average alot)
  (if (empty? alot)
      (error "EmptyListError: the input should be a no empty list.")
      (average alot)))
