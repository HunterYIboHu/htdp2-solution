...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname ex200-total-time) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
; main functions
; LTracks -> Number
; produces the total amount of play time, by miliesecond.

(check-expect (total-time 1-Track) (+ 266000 261000 231000))
(check-expect (total-time 2-Track) (+ 261000 266000))
