...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname ex206-find-association) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
; produces the first Association whose first item is equal to key or
; default if there is no such Association 

(check-expect (find-association "name" 1-music DEF) 1-name)
(check-expect (find-association "play#" 2-music DEF) 2-play#)
(check-expect (find-association "artist" 2-music DEF) 1-artist)
(check-expect (find-association "None" 3-music DEF) DEF)
