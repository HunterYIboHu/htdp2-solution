...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname ex212-data-example) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(check-expect (arrangements ED) ED-L)
(check-expect (arrangements RAT) RAT-L)
