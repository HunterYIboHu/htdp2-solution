...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname ex215-worm-game-v1) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
; (list h v) h represent the moving speed in horizenal, -1 means left,
; 1 means right, 0 means no moving on horizenal;
; v represent the moving speed in vertical, -1 means up, 1 means down,
