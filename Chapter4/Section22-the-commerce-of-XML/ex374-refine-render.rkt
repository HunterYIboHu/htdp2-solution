...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ex374-refine-render) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(define (render-item xi)
  (local ((define content (xexpr-content xi))
    ...
    (bulletize (if (word? element)
                   (text/con (word-text element))
                   (render-enum element)))))
