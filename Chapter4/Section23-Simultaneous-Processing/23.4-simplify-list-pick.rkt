...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 23.4-simplify-list-pick) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; data difinitions
; N is one of: 
; – 0
; – (add1 N)
