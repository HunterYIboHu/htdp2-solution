...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ex448-find-termination-argument) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(define ε 0.0001)
...
;; termination the functions do not terminate because every time it
;; recursive, the interval would be divided in half,
;; and after not too many times, the interval whould turn to small
;; enough.
