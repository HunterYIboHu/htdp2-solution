...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ex465-subtract) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; definitions
