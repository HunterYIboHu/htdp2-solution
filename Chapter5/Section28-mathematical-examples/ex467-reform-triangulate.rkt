...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ex467-reform-triangulate) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; definitions
